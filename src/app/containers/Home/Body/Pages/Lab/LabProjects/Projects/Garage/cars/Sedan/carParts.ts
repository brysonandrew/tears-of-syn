...
const createCarBase = () => {
    return new Promise(resolve => {
        ...
        const carBase__material = new THREE[materialType]( carMaterialOptions );
...
const createCarTop = () => {
    return new Promise(resolve => {
        ...
        const carTop__material = new THREE[materialType]( carMaterialOptions );
...
const createCarWheels = () => {
    return new Promise(resolve => {
        ...
        new Array(8).fill("_").map((_, i) => {
            ...
            const carWheel__material = new THREE[materialType]({color: 0x424242});
